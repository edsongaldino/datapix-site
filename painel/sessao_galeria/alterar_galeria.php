...
// Pega os dados
$sql_galeria = "SELECT nome, descricao, texto, localizacao, status FROM galerias WHERE id_galeria = ".$id_galeria."";
...
if($_GET['acao'] == 'alterar') {
  ...
  try{
    ...
    // REALIZA A ALTERAÇÃO
    $sql_alterar = "UPDATE galerias SET nome = '".$nome."', descricao = '".$descricao."', localizacao = '".$localizacao."', texto = '".$texto."', status = '".$status."' WHERE id_galeria = ".$id_galeria."";
          ...
          <div class="TabbedPanelsContent">
            <table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                ...
                <td><input name="nome" type="text" id="nome" value="<?php echo $executa_galeria['nome']; ?>" size="25" maxlength="50" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input name="localizacao" type="text" id="localizacao" value="<?php echo $executa_galeria['localizacao']; ?>" size="50" maxlength="150" /></td>
              </tr>
              <tr>
