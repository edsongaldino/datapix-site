...
if($excluir) {
	...
	echo "<script>";
	echo "open('gerenciar_diferenciais.php?aviso=ok&msg=Área excluída com sucesso.','_self');";
	echo "</script>";
} else {
	// Log
	...
	echo "<script>";
	echo "open('gerenciar_diferenciais.php?aviso=erro&msg=Não foi possível excluir o item.','_self');";
	echo "</script>";
}
?>