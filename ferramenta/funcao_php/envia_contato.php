...
function envia_contato($nome,$email,$telefone,$assunto,$mensagem) {
	...
	$corpo_mensagem = "
			...
			<p>Este e um e-mail enviado pelo site www.datapix.com.br.</p>
			<p>Datapix Tecnologia</p>
	...
	$mail->IsSMTP(); // Define que a mensagem será SMTP
		...
		$mail->Username = 'formulario@datapix.com.br'; // Usuário do servidor SMTP (endereço de email)
		$mail->Password = 'web@259864'; // Senha do servidor SMTP (senha do email usado)
	
		//Define o remetente
		// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
		$mail->SetFrom('contato@datapix.com.br', 'Site'); //Seu e-mail
		...
		//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
		$mail->AddAddress('contato@datapix.com.br', 'Datapix tecnologia');
